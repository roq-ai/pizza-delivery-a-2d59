...
import { getPizzaShopById } from 'apiSdk/pizza-shops';
import { PizzaShopInterface } from 'interfaces/pizza-shop';

function PizzaShopViewPage() {
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('pizza_shop', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/pizza-shops/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="pizza_shop" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
