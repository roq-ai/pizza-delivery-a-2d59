...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Pizza Delivery Application`}</title>

        <meta
          name="description"
          content="Welcome to Pizza Delivery Application - Where ordering, preparing, and delivering your favorite pizza is simplified. Enjoy festive offers, coupon codes, and free items in our comprehensive meal system."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1513104890138-7c749659a591?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxwaXp6YXxlbnwwfHx8fDE2OTQ0MTI4OTZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Pizza Delivery Application - Where ordering, preparing, and delivering your favorite pizza is simplified. Enjoy festive offers, coupon codes, and free items in our comprehensive meal system.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Pizza Shop Owner" type="pizza-shop-owner" abilities={appConfig.ownerAbilities} />
