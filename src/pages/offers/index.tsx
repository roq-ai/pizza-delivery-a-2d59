...
export function OfferListPage(props: OfferListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOffers({
        ...
        order: params.order,
        searchTermKeys: ['offer_name.contains', 'offer_code.contains', 'offer_description.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'offer_name', header: 'Offer Name', accessorKey: 'offer_name' },
    { id: 'offer_code', header: 'Offer Code', accessorKey: 'offer_code' },
    { id: 'offer_description', header: 'Offer Description', accessorKey: 'offer_description' },
    {
      id: 'start_date',
      header: 'Start Date',
